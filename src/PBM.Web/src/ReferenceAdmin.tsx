...
export default function ReferenceAdmin() {
  ...
  return <Stack spacing={2.5}>
    <Card elevation={0}><Tabs value={tab} onChange={(_, value) => setTab(value)}><Tab label="ارز و نرخ ارز" /><Tab label="تاریخچه تغییرات" /></Tabs></Card>
