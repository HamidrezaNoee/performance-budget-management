...
public sealed class PbmDbContext(DbContextOptions<PbmDbContext> options) : DbContext(options)
{
    ...
    public DbSet<CapexMilestone> CapexMilestones => Set<CapexMilestone>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CapexProject>().HasIndex(x => new { x.CompanyId, x.Code }).IsUnique();
        modelBuilder.Entity<CapexProject>().HasIndex(x => new { x.CompanyId, x.Status, x.IsActive });
        ...
        modelBuilder.Entity<ActualLedgerEntry>().HasIndex(x => x.OriginalEntryId).IsUnique().HasFilter("[OriginalEntryId] IS NOT NULL");
        modelBuilder.Entity<ActualLedgerDimension>().HasIndex(x => new { x.EntryId, x.DimensionId }).IsUnique();
        ...
        modelBuilder.Entity<CapexProject>().Property(x => x.Code).HasMaxLength(64);
        modelBuilder.Entity<CapexProject>().Property(x => x.Name).HasMaxLength(200);
        modelBuilder.Entity<CapexProject>().Property(x => x.Description).HasMaxLength(2000);
        modelBuilder.Entity<CapexProject>().Property(x => x.RequestedBudget).HasPrecision(28, 8);
        modelBuilder.Entity<CapexProject>().Property(x => x.ApprovedBudgetLimit).HasPrecision(28, 8);
        modelBuilder.Entity<CapexProject>().Property(x => x.CurrencyCode).HasMaxLength(12);
        modelBuilder.Entity<CapexProject>().Property(x => x.CompletionPercent).HasPrecision(9, 4);
        modelBuilder.Entity<CapexProject>().Property(x => x.LastDecisionComment).HasMaxLength(2000);
        modelBuilder.Entity<CapexMilestone>().Property(x => x.Code).HasMaxLength(64);
        modelBuilder.Entity<CapexMilestone>().Property(x => x.Name).HasMaxLength(200);
        ...
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.PayloadHash).HasMaxLength(64).IsFixedLength();
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.Amount).HasPrecision(28, 8);
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.CurrencyCode).HasMaxLength(12);
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.CoordinateHash).HasMaxLength(128);
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.Note).HasMaxLength(1000);
        modelBuilder.Entity<ActualLedgerEntry>().Property(x => x.ReversalReason).HasMaxLength(1000);
        ...
        modelBuilder.Entity<CapexProject>().HasOne(x => x.Tenant).WithMany().HasForeignKey(x => x.TenantId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<CapexProject>().HasOne(x => x.Company).WithMany().HasForeignKey(x => x.CompanyId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<CapexProject>().HasOne(x => x.ProjectDimensionMember).WithMany().HasForeignKey(x => x.ProjectDimensionMemberId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<CapexProject>().HasOne(x => x.OwnerOrganizationUnit).WithMany().HasForeignKey(x => x.OwnerOrganizationUnitId).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<ActualLedgerEntry>().HasOne(x => x.Measure).WithMany().HasForeignKey(x => x.MeasureId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ActualLedgerEntry>().HasOne(x => x.CreatedByUser).WithMany(x => x.ActualLedgerEntries).HasForeignKey(x => x.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ActualLedgerEntry>().HasOne(x => x.OriginalEntry).WithMany(x => x.Reversals).HasForeignKey(x => x.OriginalEntryId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ActualLedgerDimension>().HasOne(x => x.Entry).WithMany(x => x.Dimensions).HasForeignKey(x => x.EntryId).OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<ActualLedgerDimension>().HasOne(x => x.Dimension).WithMany().HasForeignKey(x => x.DimensionId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ActualLedgerDimension>().HasOne(x => x.Member).WithMany().HasForeignKey(x => x.MemberId).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<KpiObjectiveLink>().HasOne(x => x.Objective).WithMany().HasForeignKey(x => x.ObjectiveId).OnDelete(DeleteBehavior.Restrict);
